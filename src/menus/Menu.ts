...
export type MenuEvents = {
    ...
    menuChange: ( menu: Menu, opened: boolean ) => void,
...
export default class Menu {
    ...
    private _poolOpening: Menu = null;
    ...
    public Children: Map<string, Menu>; // (UUIDV4, NativeUI)
    ...
    public AddSubMenu( subMenu: Menu, itemToBindTo: UIMenuItem ) {
